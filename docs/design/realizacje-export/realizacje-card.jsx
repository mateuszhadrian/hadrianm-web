    ...
    >
      {t.blobs.map((bl, i) => {
        ...
        return (
          <div
            ...
            style={{
              position: "absolute",
              left: `calc(${bl.x * 100}% - ${d / 2}vw)`,
              top: `calc(${bl.y * 100}% - ${d / 2}vw)`,
              width: `${d}vw`,
              height: `${d}vw`,
              borderRadius: "50%",
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(135% 100% at 50% 30%, rgba(0,0,0,0) 46%, rgba(0,0,0,0.55) 100%)",
        }}
      ></div>
      <div
        style={{
          ...
          opacity: 0.85,
          backgroundImage:
            "radial-gradient(circle at center, rgba(0,0,0,0.96) 1.1px, rgba(0,0,0,0) 2.4px)",
  ...
  return (
    <div
      style={{
        ...
        alignItems: isC ? "center" : "flex-start",
        textAlign: isC ? "center" : "left",
        gap: compact ? 12 : 16,
      }}
    >
      <div
        style={{
          ...
          gap: 10,
          flexWrap: "wrap",
          justifyContent: isC ? "center" : "flex-start",
        }}
      >
        <span
          style={{
            ...
            color: t.accent,
            border: `1px solid rgba(${t.glowRGB},0.45)`,
            borderRadius: 999,
            padding: "5px 11px",
          }}
        >
      ...
      <div
        ...
        style={{
          ...
          fontSize: 14,
          color: t.ink,
          border: `1px solid rgba(${t.glowRGB},0.4)`,
          borderRadius: 999,
          padding: "9px 16px",
        }}
      >
        <span>Zobacz realizację</span>
        <span className="rz-cta-arrow" style={{ display: "inline-flex" }}>
          <RzArrow size={15}></RzArrow>
        </span>
      </div>
    </div>
  );
...
function RzCard({
  ...
  if (layout === "horizontal") {
    return (
      <button
        type="button"
        className="rz-card rz-card--h"
        onClick={open}
        style={{
          display: "grid",
          gridTemplateColumns: flip ? "1fr 1.15fr" : "1.15fr 1fr",
