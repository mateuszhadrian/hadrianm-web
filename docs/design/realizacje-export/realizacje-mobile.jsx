  ...
  const inner = (
    <button
      ...
      style={{
        ...
        alignItems: cfg.align === "center" ? "center" : "stretch",
        gap: cfg.gap,
        width: "100%",
      }}
    >
...
function MobilePage({ t, tw, variant, hover, onOpen }) {
  return (
    <div style={{ minHeight: "100%" }}>
      ...
      >
        <div style={{ fontFamily: t.display, fontWeight: 800, fontSize: 17 }}>
          hadrian<span style={{ color: t.muted }}>m</span>
        </div>
        <div
          style={{
            display: "flex",
      ...
      <div style={{ textAlign: "center", padding: "20px 24px 10px" }}>
        ...
        >
          ...
          <span
            style={{
              ...
              fontStyle: "italic",
              fontWeight: 400,
              background: "linear-gradient(105deg,#FFF6F0 10%,#FFB3A6 90%)",
        ...
        >
          Wybrane projekty — każdy w wersji desktop i mobilnej. Dotknij, by
          zobaczyć szczegóły.
        </p>
      </div>
